...
public class ListBinaryOrUDAFEvaluator  extends GenericUDAFEvaluator {
    ...
    public ObjectInspector init(Mode m, ObjectInspector[] parameters)
        ...
        // initialize input object inspectors
	...
	@Override
	public void iterate(AggregationBuffer agg, Object[] arg1) throws HiveException {
		assert(arg1.length == 1);
		if (arg1[0] != null) {
			BinaryOrAgg myagg = (BinaryOrAgg) agg;
			PrimitiveObjectInspector listElementOI = (PrimitiveObjectInspector) inputOI.getListElementObjectInspector();
			int nObjects = inputOI.getListLength(arg1[0]);
			for (int i = 0; i < nObjects; i++){
				Object p1 = listElementOI.getPrimitiveJavaObject(inputOI.getListElement(arg1[0], i));
